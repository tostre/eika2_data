...
train(train_loader_emotion_full, net_full, epochs=100, criterion, 5000, "../logs/mse_emotion_full", cuda, 0.1)
...
train(train_loader_emotion_nolex, net_half, epochs=100, criterion, 5000, "../logs/mse_emotion_nolex", cuda, 0.1)
...
train(train_loader_emotion_lex, net_half, epochs=100, criterion, 5000, "../logs/mse_emotion_lex", cuda, 0.1)
...
train(train_loader_tweet_full, net_full, epochs=100, criterion, 5000, "../logs/mse_tweet_full", cuda, 0.1)
...
train(train_loader_tweet_nolex, net_half, epochs=100, criterion, 5000, "../logs/mse_tweet_nolex", cuda, 0.1)
...
train(train_loader_tweet_lex, net_half, epochs=100, criterion, 5000, "../logs/mse_tweet_lex", cuda, 0.1)
