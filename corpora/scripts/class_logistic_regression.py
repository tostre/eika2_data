...
def load_vector_data(dataset_name, bgr=False):
    ...
    return train_test_split(inputs, targets, test_size=0.2)
...
def classify_with_lr(dataset_name, feature_set_name, train_x, test_x, train_y, test_y):
    ...
    # model metadata
    score, f1_scoore = lr.score(train_x, train_y), f1_score(test_y, pred_y, average="micro")
...
load_vector_data("norm_test", bgr=False)
