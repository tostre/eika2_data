...
def train(epochs):
	...
	for e in range(epochs): 
		...
		torch.save(lstm.state_dict(), "lstm_emotion.pt")
...
### script part
#train_x, test_x, train_y, test_y = load_datasets(["emotion_classification_1", "emotion_classification_2", "emotion_classification_3", "emotion_classification_4", "emotion_classification_5", "emotion_classification_6", "emotion_classification_7", "emotion_classification_8"])
train_x, test_x, train_y, test_y = load_datasets(["emotion_classification_1"])
